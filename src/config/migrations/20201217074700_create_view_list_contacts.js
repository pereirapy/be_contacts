exports.up = function(knex) {
  return knex.schema.raw(`CREATE VIEW "viewListContacts" AS ?`, [
    knex
      .select(
        'contacts.name',
        'contacts.owner',
      ...
      .joinRaw(
        `LEFT JOIN lateral (
        SELECT information, "phoneContact", "detailsContacts"."createdAt" as "createdAtDetailsContacts", DATE_PART('day', now() - "detailsContacts"."createdAt") as "lastConversationInDays"
