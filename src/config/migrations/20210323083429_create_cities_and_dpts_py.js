...
exports.up = async function (knex) {
  await knex.schema
    ...
    .createTable(tableNameCities, function (table) {
      ...
      table.dateTime('createdAt').notNullable().defaultTo(knex.fn.now())
      table.foreign('idDepartment').references('id').inTable(tableNameDpts)
    })
  ...
  await knex.schema.alterTable(tableNameContacts, function (t) {
    t.integer('idLocation').nullable().alter()

    t.foreign('idLocation').references('id').inTable('cities')
  })
...
exports.down = async function (knex) {
  ...
  await knex.schema.alterTable(tableNameContacts, function (t) {
    t.string('location').nullable().alter()
  })
